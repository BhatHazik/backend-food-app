...
router.post('/seller/accept/:offer_id', restaurantAuth.protect, offersController.acceptOfferSeller)
router.get('/', offersController.getOffers);
router.get('/getOffersFromRestaurant/:restaurant_id', protect, offersController.getOffersFromRestaurants)
