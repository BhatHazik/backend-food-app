...
router.get(
  "/topRated/:latitude/:longitude",
  userAuth.protect,
  getAllTopRatedRestaurants
);
router.get(
  "/popular/:latitude/:longitude",
  userAuth.protect,
  getAllPopularRestaurants
);
...
router.post(
  "/submitRestaurantDocs",
  restaurantAuth.protect,
  createRestaurantDocs
);

router.get("/getRestaurant", restaurantAuth.protect, getRestaurantById);
